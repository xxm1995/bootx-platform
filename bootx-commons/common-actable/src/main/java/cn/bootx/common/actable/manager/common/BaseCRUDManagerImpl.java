package cn.bootx.common.actable.manager.common;

import cn.bootx.common.actable.command.PageResultCommand;
import cn.bootx.common.actable.command.SaveOrUpdateDataCommand;
import cn.bootx.common.actable.dao.common.BaseCRUDMapper;
import cn.bootx.common.actable.utils.ColumnUtils;
import cn.bootx.common.actable.utils.FieldUtils;
...
public class BaseCRUDManagerImpl implements BaseCRUDManager {
     ...
     * 根据实体对象的非Null字段作为Where条件查询结果集，如果对象的属性值都为null则返回全部数据等同于selectAll+分页
     *
     * @param t 实体对象(如果要支持分页实体对象可以继承cn.bootx.common.actable.command.BaseModel)

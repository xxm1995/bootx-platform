...
public class BpmTaskNoticeService {
    ...
    public void taskAssign(TaskAssignEvent event) {
        ...
        String oldTitle = StrUtil.format("{} 的 {} 任务已成功被委派给 {}", bpmTask.getInstanceName(), bpmTask.getNodeName(),
                event.getNewAssignName());
        ...
        String newTitle = StrUtil.format("{} 的 {} {} 任务已经委派给您", event.getOldAssignName(), bpmTask.getInstanceName(),
                bpmTask.getNodeName());

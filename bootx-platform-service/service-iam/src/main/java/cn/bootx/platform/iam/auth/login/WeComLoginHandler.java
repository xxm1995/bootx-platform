...
import cn.bootx.platform.iam.service.third.UserTiredOperateService;
...
public class WeComLoginHandler implements OpenIdAuthentication {
    ...
    public String getLoginType() {
        return AuthLoginTypeCode.WE_COM;
    }
    ...
    public void bindUser(String authCode, String state) {
        ...
        userTiredOperateService.bindOpenInfo(userId, authUser, AuthLoginTypeCode.WE_COM);
    }
